...
dmm_plot <- dmm_plot + theme(legend.position = "none") +
  labs(title = "DC with sqrt", subtitle = "", x = "", y = "")
dmm_plot_alt <- dmm_plot_alt +
  labs(title = "DC without sqrt", subtitle = "", x = "", y = "")
comp_plot <- (dmm_plot | dmm_plot_alt) +
